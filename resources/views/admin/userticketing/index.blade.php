...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('userticketing.create')}}" class="btn btn-rounded btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;{{__('Tambah')}}</a>
        </div>
        {{-- <div class="col-md-8">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: #d3d3d3">User</div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($user as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value->ussername_user ? $value->ussername_user :''}}</td>
                                        ...
                                        <td>{{$value->id_jenisrequest? $value->name :''}}</td>
                                      
                                        <td> <a href="{{route('userticketing.edit', encrypt($value->id))}}" class=""><span class=""></span>
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        <td>
        <form action="{{ route('userticketing.destroy', $value->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
